        ...
        <footer className="bg-gray-100 py-20 px-4 max-md:px-8">
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    {/* Links Section */}
                    <div>
                        <h3 className="font-semibold text-gray-900 mb-4 text-sm uppercase tracking-wider">Links</h3>
                        <ul className="space-y-3">
                            {linksData.map((link, index) => (
                                <li key={index}>
                                    <a href={link.href} className="text-gray-600 hover:text-gray-900 text-sm link link-hover">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {legalData.map((legal, index) => (
                                <li key={index}>
                                    <a href={legal.href} className="text-gray-600 hover:text-gray-900 text-sm link link-hover">
                                        {legal.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    {/* More Section */}
                    <div>
                        <h3 className="font-semibold text-gray-900 mb-4 text-sm uppercase tracking-wider">More</h3>
                        <ul className="space-y-3">
                            {moreData.map((item, index) => (
                                <li key={index}>
                                    <a href={item.href} className="text-gray-600 hover:text-gray-900 text-sm link link-hover">
                                        {item.label}
                                    </a>
                                </li>
                            ))}
                ...
                <div className="border-t border-gray-300 pt-8">
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-gray-700 text-sm">
                            Hey Curious 👋 I&apos;m <span className="underline font-semibold cursor-pointer link link-hover">Mare</span>, the creator of Zenvoice. You can follow my work on <span className="underline font-semibold cursor-pointer link link-hover">Twitter</span>.
                        </p>
                    </div>
                </div>
            </div>
